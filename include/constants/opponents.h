...
#define TRAINER_ASHBAND_SCOUT               855 // Wasteland: first custom trainer, on Wasteland_Road
#define TRAINER_ASHBAND_CHECKPOINT_GRUNT    856 // Wasteland: guards Wasteland_AshbandCheckpoint
...
//       See docs/roster.md for the full custom trainer list

#define TRAINERS_COUNT_EMERALD     928
